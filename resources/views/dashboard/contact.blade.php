...
@section('menu-item1')Notícias @endsection
@section('menu-item2')Login @endsection
    ...
    <div class="container px-5">
        ...
        <div class="rounded-3 py-5 px-4 px-md-5 mb-5">
            <div class="text-center mb-5">
                ...
                <p class="lead fw-normal text-muted mb-0">Sua informação é de grande importância</p>
            </div>
