...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
            <!-- Navigation-->
            <nav class="navbar navbar-expand-lg navbar-dark bg-light-purple">
                <div class="container px-5">
                    <a class="navbar-brand" href="#">LGBT+ Rural</a>
                    ...
                    <div class="row gx-5 align-items-center justify-content-center">
                        <div class="col-lg-8 col-xl-7 col-xxl-6">
                            <div class="my-5 text-center text-xl-start">
                                <h1 class="display-5 fw-bolder text-white mb-2">@yield('text-title')</h1>
                                <p class="lead fw-normal text-white-50 mb-4">@yield('about-text')</p>
                                <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xl-start">
                                    <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#">Formulário</a>
                                    <a class="btn btn-outline-light btn-lg px-4" href="#features">Aprenda mais</a>
                                </div>
                            </div>
                        </div>
            ...
            <!-- antigo glossário section-->
            {{-- <section class="py-5" id="features">
                <div class="container px-5 my-5">
                    <div class="gx-5">
                        <div class="col-lg-4 mb-5 mb-lg-4"><h2 class="fw-bolder mb-0">Glossário</h2></div>
                        <div class="col-lg-15">
            ...
            <!-- Testimonial section-->
            {{-- NÃO USAR --}}
            {{-- <div class="py-5 bg-light-purple">
                <div class="container px-5 my-5">
        ...
        <!-- Footer-->
        @yield('footer')
        {{-- <footer class="bg-light-purple py-4 mt-auto">
            <div class="container px-5">
